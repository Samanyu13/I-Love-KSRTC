...
class LiveHistoryRequestBus extends StatefulWidget {
  @override
  _LiveHistoryRequestBusState createState() => _LiveHistoryRequestBusState();
}

class _LiveHistoryRequestBusState extends State<LiveHistoryRequestBus> {
  bool _loading = true;
  String _id, _token;
  List _data;
  ...
  void retrieveData() async {
    try {
      ...
      url = url + '/private/user/getNotSumbmittedByUserID';
        ...
        if (ret.success) {
          ...
          if (_data.isEmpty) {
            showAlertBox(context, 'MESSAGE',
                'Looks like you do not have any live history..!');
          }
        } else {
